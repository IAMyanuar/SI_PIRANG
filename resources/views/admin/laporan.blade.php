        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-7 align-self-center">
                    <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Laporan Peminjaman</h3>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>selesai</td>
                                                    <td><a class="btn btn-primary btn-rounded" href="/laporan/detaillaporan">Detail</a></td>
                                                </tr>
                                                {{-- <?php $nomor = 1; ?>
                                                <?php
